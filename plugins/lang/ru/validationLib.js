...
function validationLib (opt) {
  return {
    ...
    PHONE: `Поле «${opt.field_name} должно соответствовать маске.`,
...
Vue.prototype.$validationLib = validationLib
